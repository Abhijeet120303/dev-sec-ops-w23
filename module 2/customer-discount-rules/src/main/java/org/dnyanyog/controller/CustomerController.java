...
public class CustomerController {
	...
	@PostMapping(path = "/api/v1/customer/discount", consumes = { "application/json", "application/xml" }, produces = {
			"application/json", "application/xml" })
	public OrderResponse discount(@RequestBody OrderRequest orderRequest) {
		return customerService.discount(orderRequest);
